        ...
        builder: (BuildContext context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              ...
              Text('คุณต้องการเพิ่มรายการนี้ในรายการแนะนำหรือไม่?',
                  style: TextStyle(
                      color: Colors.grey[900],
                      fontSize: 16,
                      fontWeight: FontWeight.w700)),
                      ...
                      if (ab.userType == 'tester') {
                        ...
                        await context
                          ...
                          if (featuredList.length <= 10) {
                            ...
                            openDialog(
                                context,
                                'รายการแนะนำมีเนื้อหามากกว่า 10 รายการ!',
                                'ขีดจำกัดของรายการแนะนำคือ 10 รายการ โปรดลบบางรายการออกจากเนื้อหาแนะนำแล้วลองอีกครั้ง');
                          }
                        });
                      }
                    },
    ...
    return PopupMenuButton(
      ...
      itemBuilder: (BuildContext context) {
        return <PopupMenuItem>[
          ...
          PopupMenuItem(
            child: Text('ความคิดเห็นมากที่สุด'),
            value: 'ความคิดเห็น',
          ),
        ];
      },
      onSelected: (dynamic value) {
        ...
        } else if (value == 'เป็นที่นิยม') {
          setState(() {
            _sortByText = 'ที่นิยมมากที่สุด';
            _orderBy = 'loves';
            _descending = true;
          });
        } else if (value == 'ความคิดเห็น') {
          setState(() {
            _sortByText = 'ความคิดเห็นมากที่สุด';
