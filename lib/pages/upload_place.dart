...
class _UploadPlaceState extends State<UploadPlace> {
  ...
  List<Map<String, dynamic>> paths1 = [];
  List<Map<String, dynamic>> paths2 = [];
  final int _loves = 0;
  ...
  Future saveToDatabase() async {
    ...
    await ref.set(_placeData).then((value) => ref1.set(_guideData).then(
        (value) =>
            ref2.set(_guideData1).then((value) => ref3.set(_guideData2))));
  }
      ...
      body: Form(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              TextFormField(
                decoration:
                    inputDecoration('ป้อนชื่อสถานที่', 'ชื่อสถานที่', nameCtrl),
                controller: nameCtrl,
                validator: (value) {
              ...
              Row(
                children: <Widget>[
                  ...
                  Expanded(
                    child: TextFormField(
                      decoration:
                          inputDecoration('ป้อนลองจิจูด', 'ลองจิจูด', lngCtrl),
                      keyboardType: TextInputType.number,
                      controller: lngCtrl,
                      validator: (value) {
                        if (value!.isEmpty) return 'ค่าว่างเปล่า';
              ...
              TextFormField(
                decoration:
                    inputDecoration('ป้อน URL รูปภาพ', 'ภาพที่ 2 ', image2Ctrl),
              ...
              TextFormField(
                decoration:
                    inputDecoration('ป้อน URL รูปภาพ', 'ภาพที่ 3', image3Ctrl),
                  ...
                  if (value.length == 0) {
                    ...
                    if (pathInfo.length != 7) {
                      ...
                      try {
                        ...
                        String imageCtrl = pathsCtrl.text.split(',')[3].trim();
                        String detailCtrl = pathsCtrl.text.split(',')[4].trim();
                        String audioUrlCtrl =
                            pathsCtrl.text.split(',')[5].trim();
                        String radiusCtrl = pathsCtrl.text.split(',')[6].trim();
                        ...
                        setState(() {
                          _helperText = 'Invalid input format: ${e.toString()}';
                        });
                      }
                    }
                  }
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      ...
                                      _helperText = 'ลบ ${paths.length} รายการ';
                                    });
                                  },
                                ),
                              ],
                  ...
                  if (value.length == 0) {
                    ...
                    if (pathInfo.length != 7) {
                      ...
                      try {
                        ...
                        String imageCtrl = paths1Ctrl.text.split(',')[3].trim();
                        String detailCtrl =
                        ...
                        setState(() {
                          ...
                          _helperText1 = 'เพิ่ม ${paths1.length} รายการ';
                          print(paths1);
                        });
                      } catch (e) {
                        setState(() {
                  ...
                  if (value.length == 0) {
                    ...
                    if (pathInfo.length != 7) {
                      ...
                      try {
                        ...
                        String imageCtrl = paths2Ctrl.text.split(',')[3].trim();
                        String detailCtrl =
